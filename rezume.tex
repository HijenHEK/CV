...
\resumeHeadingListStart{}
  ...
  {\href{https://360medlink.com/}{360Medlink} }{Hybride -- Ariana, Tunisie}
    \resumeItemListStart{}
      ...
      \resumeItem{Utiliser Jira et les solutions du Atlassian pour gérer les taches entre les membres d'équipe en adoptant la méthodologie \textbf{Scrum agile} .} \\
      \resumeItem{Contribuer au Développement des API en adoptant \textbf{la méthodologies TDD}.}
      \resumeItem{Debugger les codes et résoudre les erreurs des différentes applications back-ends.}
  ...
  {\href{https://iwatch.tn/}{IWatch Org} }{Hybride -- Tunis, Tunisie}
    \resumeItemListStart{}
      \resumeItem{Développement des applications et maintenance des sites web du IWatch Org.}
      \resumeItem{Gestion des hébergements et des serveurs de IWatch Org .}
      \resumeItem{Création et gestion d'un compte \textbf{d'organisation sur Github}.}
...
\resumeQuadHeading{Développeur Cobol | Consultant HRAccess}{Jul 2019 -- Fev 2020}
  {\href{hhttps://www.soprahr.com/}{SopraHR} }{Sur Site -- Tunis, Tunisie}
    \resumeItemListStart{}
      \resumeItem{Analyse des besoins du client, Création et Mise à jour des fonctionnalités sur le produit HR Access.}
      \resumeItem{Création des documentations pour guider le client lors de l'utilisation du produit et expliquer schématiquement les nouvelles fonctionnalités.}
      \resumeItem{Travailler dans une équipe de 5 personnes pour bien debugger les erreurs et les résoudre.}
...
\resumeQuadHeading{Stagiaire : Développeur Full Stack  (PFE)}{Fev 2019 -– Mai 2019}
    ...
    \resumeItemListStart{}
      \resumeItem{Étude détaillé du Laravel et vuejs.},
      \resumeItem{Conception et développement d'une application de gestion des projets.}
...
\resumeQuadHeading{Stagiaire : Java Développeur}{Juin 2018 –- Août 2018}
    {\href{hhttps://www.etap.tn/}{ETAP}}{Sur Site -- Ariana, Tunisie}
    \resumeItemListStart{}
      \resumeItem{Étude détaillé du Java et MySQL.}
      \resumeItem{Développement d'une application de gestion des stocks avec Java (JDS).}
...
\section{Formations}
  \resumeHeadingListStart{}
    ...
    {Étude Ingénieur en génie logicielle .}{Sept 2019 – Présent}

    \resumeQuadHeading{ISTIC}{Borj Cedria, Ben Arous, Tunisie}
    {Licence en Science Informatique.}{Sept 2016 – May 2019}
